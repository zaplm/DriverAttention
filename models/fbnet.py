...
class FBNet(nn.Module):
    def __init__(self, input_dim=3):
        ...
        # feedback
        self.conv_c2_feedback = nn.Conv2d(64, 64, kernel_size=3, stride=1, padding=1)
        self.conv_c3_feedback = nn.Conv2d(128, 64, kernel_size=3, stride=1, padding=1)
        self.conv_c4_feedback = nn.Conv2d(256, 64, kernel_size=3, stride=1, padding=1)
        self.conv_c5_feedback = nn.Conv2d(512, 64, kernel_size=3, stride=1, padding=1)

        # fusion layers
        self.conv_c1_fusion = nn.Conv2d(64 + 128 + 256 + 512, filtersize, kernel_size=3, stride=1, padding=1)
        self.conv_c2_fusion = nn.Conv2d(64 + 128 + 256 + 512, filtersize, kernel_size=3, stride=1, padding=1)
        self.conv_c3_fusion = nn.Conv2d(64 + 128 + 256 + 512, filtersize, kernel_size=3, stride=1, padding=1)
        self.conv_c4_fusion = nn.Conv2d(64 + 128 + 256 + 512, filtersize, kernel_size=3, stride=1, padding=1)
        self.conv_c5_fusion = nn.Conv2d(64 + 128 + 256 + 512, filtersize, kernel_size=3, stride=1, padding=1)
