        ...
        if len(list_frames) >= 2 * len_temporal - 1:
            ...
            for i in range(len(list_frames)):
                ...
                if i >= len_temporal - 1:
                    ...
                    process(model, clip, path_outdata, list_frames[i])

                    # process first (len_temporal-1) frames
                    if i < 2 * len_temporal - 2:
                        process(model, torch.flip(clip, [2]), path_outdata, list_frames[i - len_temporal + 1])
